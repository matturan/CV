...
\moveleft.5\hoffset\centerline{\large\bf Mehmet~Ali~Tu\u{g}tekin Turan}

% Horizontal line after name; adjust line thickness by changing the '1pt'
\moveleft\hoffset\vbox{\hrule width\resumewidth height 1pt}\smallskip

\moveleft0.5\hoffset\centerline{Postdoctoral Research Associate, INRIA}
...
{\sl Doctor of Philosophy} \hfill October 2013 - March, 2019 \\[.3em]
...
\item \textit{GPA:} 3.43 / 4.00
\item Full scholarship from Ford Company, Turkey
\item Grant support by the Scientiﬁc and Technological Research Council of Turkey (T\"{U}B{\.I}TAK)
\end{itemize}
